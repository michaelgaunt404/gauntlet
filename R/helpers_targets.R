...
#' @param rm_tar_load Logical; indicating whether to remove lines with `tar_load` commands. This is useful for identifying `tar_load` commands that are not used in the analysis, providing a list of `tar` objects that are actually used. Default is \code{TRUE}.
#'
